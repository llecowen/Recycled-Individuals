...
an individual, can be used to estimate tag retention rates. Double tagging studies have been used for a wide variety of species (for example cod \cite{Bjornsson:2011}, lobsters\cite{Xu:2014}:, sea turtles \cite{Bjorndal:1996}, elephant seals \cite{Pistorius:2000})   to investigate tag loss and tag shedding rates.  Often a
