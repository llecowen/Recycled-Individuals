...
###Notation
The following is a description of statistics and parameters used in the JSTL model where survival, capture, and tag retention probabilities are assumed to be constant across time. 
...
m=1
repeat{
assign(paste("tableESTS.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000/",m,".ests.txt",sep=""), sep=" "))
assign(paste("tableESTSrecycled.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000/",m,".estsRECYCLED.txt",sep=""), sep=" "))
m=m+1
if(m>27){break}
}
...
#GJSTL N=1000 frac=1
assign(paste("tableESTSrecycled.GJSTL1.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000/",3,".estsRECYCLED.txt",sep=""), sep=" "))
assign(paste("tableESTS.GJSTL1.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000/",3,".ests.txt",sep=""), sep=" "))
...
assign(paste("tableESTSrecycled.GJSTL4.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000HALF/",3,".estsRECYCLED.txt",sep=""), sep=" "))
assign(paste("tableESTS.GJSTL4.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000HALF/",3,".ests.txt",sep=""), sep=" "))
...
assign(paste("tableESTSrecycled.GJSTL2.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations100000/",3,".estsRECYCLED.txt",sep=""), sep=" "))
assign(paste("tableESTS.GJSTL2.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations100000/",3,".ests.txt",sep=""), sep=" "))
...
assign(paste("tableESTSrecycled.GJSTL3.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations100000HALF/",3,".estsRECYCLED.txt",sep=""), sep=" "))
assign(paste("tableESTS.GJSTL3.",3,sep=""),read.table(paste("~/Dropbox/Project/Simulations100000HALF/",3,".ests.txt",sep=""), sep=" "))
...
m=3
repeat{
assign(paste("tableESTS10.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000/",m,".ests.txt",sep=""), sep=" "))
assign(paste("tableESTS10recycled.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000/",m,".estsRECYCLED.txt",sep=""), sep=" "))
assign(paste("tableESTS7.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000time7/",m,".ests.txt",sep=""), sep=" "))
assign(paste("tableESTS7recycled.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000time7/",m,".estsRECYCLED.txt",sep=""), sep=" "))
assign(paste("tableESTS5.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000time5/",m,".ests.txt",sep=""), sep=" "))
assign(paste("tableESTS5recycled.",m,sep=""),read.table(paste("~/Dropbox/Project/Simulations1000time5/",m,".estsRECYCLED.txt",sep=""), sep=" "))
m=m+3
if(m>10){break}
}
