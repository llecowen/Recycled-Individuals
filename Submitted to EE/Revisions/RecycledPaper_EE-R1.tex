...
\hypersetup{unicode=true,
            pdftitle={Complete tag loss in capture-recapture estimates affect abundance estimates: an elephant seal case study},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  \title{Complete tag loss in capture-recapture estimates affect abundance estimates: an elephant seal case study.}
